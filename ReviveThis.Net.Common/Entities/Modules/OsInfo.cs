/*
 Initial code provided by csharp411
        ...
        if (GetVersionEx(ref osVersionInfo))
        {
          ...
          switch (majorVersion)
          {
            ...
            case 5:
              ...
              {
                case VER_NT_WORKSTATION:
                  edition = (suiteMask & VER_SUITE_PERSONAL) != 0 ? "Home" : (GetSystemMetrics(86) == 0 ? "Professional" : "Tablet Edition");
                  break;
                case VER_NT_SERVER:
                  if (minorVersion == 0)
                  {
                  ...
                  case 5:
                    switch (minorVersion)
                    {
                      ...
                      case 1:
                        ...
                        break;
                      case 2:
                        name = productType == VER_NT_WORKSTATION ? "Windows XP" : "Windows Server 2003";
                        //name = "Windows Server 2003"; //64-Bit Edition
                        break;
                    }
                    break;
                  case 6:
